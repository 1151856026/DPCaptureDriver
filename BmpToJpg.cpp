...
WCHAR *LBmpToJpg::BStr2WStr(const char *pSource, int &iDstLen)
{
...
bool LBmpToJpg::BMPToJPG(const char *pBmpFile, const char *pJpgFile, long iQuality)
{
	bool bRet = false;
	try
	{
...
bool LBmpToJpg::JPGToBMP(const char *pJpgFile, const char *pBmpFile)
{
	bool bRet = false;
	try
	{
...
/*
bool LBmpToJpg::AddFont(const char *pSrcName, const char *pDstName, const char *pText, int iXPos, int iYPos)
{
	CLSID codecClsid;
	EncoderParameters encoderParameters;
	GdiplusStartupInput gdiplusStartupInput;
